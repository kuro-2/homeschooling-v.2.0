...
function App() {
  ...
  // State to manage which content is currently displayed
    ...
    <div className={`${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'} overflow-x-hidden transition-colors duration-300`}>
      ...
      <style>
        ...
        ::-webkit-scrollbar-thumb {
          background-color: ${isDarkMode ? 'rgba(156, 163, 175, 0.3)' : 'rgba(107, 114, 128, 0.3)'}; /* Color of the scroll thumb */
        ...
        ::-webkit-scrollbar-thumb:hover {
          background-color: ${isDarkMode ? 'rgba(156, 163, 175, 0.5)' : 'rgba(107, 114, 128, 0.5)'}; /* Color of the scroll thumb on hover */
        }

        /* For Firefox */
        html {
          scrollbar-width: thin; /* "auto" or "thin" */
          scrollbar-color: ${isDarkMode ? 'rgba(156, 163, 175, 0.3) transparent' : 'rgba(107, 114, 128, 0.3) transparent'}; /* thumb and track color */
        }
        `}
      </style>

      {/* Navigation */}
      <nav className={`fixed top-0 w-full ${isDarkMode ? 'bg-gray-900/95 border-gray-800' : 'bg-[#3D67FF]/95 border-[#3D67FF]'} backdrop-blur-sm z-50 border-b transition-all duration-300`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button onClick={() => handleNavLinkClick('home', 'about')} className={`${isDarkMode ? 'text-gray-400 hover:text-gray-200' : 'text-white hover:text-blue-200'} transition-all duration-300 hover:scale-105 relative group`}>
                About Us
              ...
              <button onClick={() => handleNavLinkClick('home', 'how-it-works')} className={`${isDarkMode ? 'text-gray-400 hover:text-gray-200' : 'text-white hover:text-blue-200'} transition-all duration-300 hover:scale-105 relative group`}>
                How It Works
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-300 to-blue-300 group-hover:w-full transition-all duration-300"></span>
              </button>
              <button onClick={() => handleNavLinkClick('home', 'ai-tools')} className={`${isDarkMode ? 'text-gray-400 hover:text-gray-200' : 'text-white hover:text-blue-200'} transition-all duration-300 hover:scale-105 relative group`}>
                AI Tools
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-300 to-blue-300 group-hover:w-full transition-all duration-300"></span>
              </button>
              <button onClick={() => handleNavLinkClick('home', 'why-choose-us')} className={`${isDarkMode ? 'text-gray-400 hover:text-gray-200' : 'text-white hover:text-blue-200'} transition-all duration-300 hover:scale-105 relative group`}>
                Why Choose Us?
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-300 to-blue-300 group-hover:w-full transition-all duration-300"></span>
              </button>
              <button onClick={() => handleNavLinkClick('home', 'testimonials')} className={`${isDarkMode ? 'text-gray-400 hover:text-gray-200' : 'text-white hover:text-blue-200'} transition-all duration-300 hover:scale-105 relative group`}>
                Testimonials
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-300 to-blue-300 group-hover:w-full transition-all duration-300"></span>
              </button>
              ...
              <button 
                ...
                className={`${isDarkMode ? 'text-gray-400 hover:text-gray-200' : 'text-white hover:text-blue-200'} transition-all duration-300 hover:scale-105 relative group`}
              >
                Dashboard
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-300 to-blue-300 group-hover:w-full transition-all duration-300"></span>
              </button>
              ...
              <button 
                ...
                className={`p-2 rounded-lg ${isDarkMode ? 'hover:bg-gray-800' : 'hover:bg-[#3D67FF]'} transition-all duration-300 hover:scale-110 hover:rotate-12`}
              >
                {isDarkMode ? <Sun className="w-5 h-5" /> : <Moon className="w-5 h-5 text-white" />}
              </button>
              <a href="https://dumroo.ai/login" className={`${isDarkMode ? 'bg-gradient-to-r from-blue-400 to-blue-400 hover:from-blue-500 hover:to-blue-500' : 'bg-[#FFF00] hover:bg-[#FFD700]'} px-4 lg:px-6 py-2 rounded-lg font-medium text-white text-sm transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:-translate-y-0.5`}>
                Get Started
              </a>
            </div>
        ...
        {/* Mobile menu */}
        {isMenuOpen && (
          <div className={`md:hidden ${isDarkMode ? 'bg-gray-900 border-gray-800' : 'bg-[#3D67FF] border-[#3D67FF]'} border-t transition-all duration-300 animate-slide-down`}>
            <div className="px-4 py-4 space-y-4">
              {/* Updated mobile navigation links */}
              <button onClick={() => handleNavLinkClick('home', 'about')} className={`block ${isDarkMode ? 'text-gray-400 hover:text-gray-200' : 'text-white hover:text-blue-200'} transition-all duration-300 hover:translate-x-2 hover:scale-105`}>About Us</button>
              <button onClick={() => handleNavLinkClick('home', 'how-it-works')} className={`block ${isDarkMode ? 'text-gray-400 hover:text-gray-200' : 'text-white hover:text-blue-200'} transition-all duration-300 hover:translate-x-2 hover:scale-105`}>How It Works</button>
              <button onClick={() => handleNavLinkClick('home', 'ai-tools')} className={`block ${isDarkMode ? 'text-gray-400 hover:text-gray-200' : 'text-white hover:text-blue-200'} transition-all duration-300 hover:translate-x-2 hover:scale-105`}>AI Tools</button>
              <button onClick={() => handleNavLinkClick('home', 'why-choose-us')} className={`block ${isDarkMode ? 'text-gray-400 hover:text-gray-200' : 'text-white hover:text-blue-200'} transition-all duration-300 hover:translate-x-2 hover:scale-105`}>Why Choose Us?</button>
              <button onClick={() => handleNavLinkClick('home', 'testimonials')} className={`block ${isDarkMode ? 'text-gray-400 hover:text-gray-200' : 'text-white hover:text-blue-200'} transition-all duration-300 hover:translate-x-2 hover:scale-105`}>Testimonials</button>
              {/* New Mobile Navigation Links */}
              <button 
                onClick={() => handleNavLinkClick('dashboard')} 
                className={`flex items-center gap-2 ${isDarkMode ? 'text-gray-400 hover:text-gray-200' : 'text-white hover:text-blue-200'} transition-all duration-300 hover:translate-x-2 hover:scale-105`}
              >
        ...
        <>
          ...
          <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 py-16 sm:py-20">
            ...
            <div className={`absolute inset-0 ${
              isDarkMode 
                ...
                : 'bg-gradient-to-br from-blue-50/30 via-white/40 to-blue-50/30'
            ...
            <div className="relative z-10 max-w-6xl mx-auto text-center w-full">
              <div className="space-y-8 scroll-animate">
                <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight animate-fade-in-up px-2">
                  <span className={isDarkMode ? "bg-gradient-to-r from-blue-300 via-blue-300 to-teal-300 bg-clip-text text-transparent" : "text-[#3D67FF]"}>
                    Empower Your
                  </span>
                  <br />
                  <span className={isDarkMode ? "bg-gradient-to-r from-blue-300 via-teal-300 to-blue-300 bg-clip-text text-transparent" : "text-[#3D67FF]"}>
                    Homeschooling Journey
                  </span>
                </h1>
                
                <p className={`text-sm xs:text-base sm:text-lg md:text-xl ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} max-w-4xl mx-auto leading-relaxed animate-fade-in-up animation-delay-200 px-4`}>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-8 sm:mb-12 lg:mb-16 scroll-animate">
                <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 animate-fade-in-up px-2">
                  <span className={isDarkMode ? 'text-white' : 'text-[#3D67FF]'}>Everything You Need to</span>
                  <br />
                  <span className={isDarkMode ? "bg-gradient-to-r from-blue-300 to-blue-300 bg-clip-text text-transparent" : "text-[#3D67FF]"}>
                    Succeed
                  </span>
                </h2>
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                {features.map((feature, index) => (
                  <div key={index} className={`${isDarkMode ? 'bg-gray-800/50 border-gray-700 hover:border-gray-600' : 'bg-white/70 border-gray-200 hover:border-gray-300'} backdrop-blur-sm rounded-xl p-4 sm:p-6 lg:p-8 border transition-all duration-300 hover:transform hover:scale-105 hover:shadow-xl hover:-translate-y-2 group scroll-animate`} style={{animationDelay: `${index * 100}ms`}}>
                    ...
                    <h3 className={`text-base sm:text-lg lg:text-xl font-bold ${isDarkMode ? 'text-white' : 'text-[#3D67FF]'} mb-2 sm:mb-3 lg:mb-4 group-hover:text-blue-400 transition-colors duration-300`}>
                      {feature.title}
                    </h3>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              <div className="text-center mb-8 sm:mb-12 lg:mb-16 scroll-animate">
                <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 px-2">
                  <span className={isDarkMode ? 'text-white' : 'text-[#3D67FF]'}>How It </span>
                  <span className={isDarkMode ? "bg-gradient-to-r from-blue-300 to-blue-300 bg-clip-text text-transparent" : "text-[#3D67FF]"}>
                    Works
                  </span>
                </h2>
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                ...
                <div className="text-center scroll-animate">
                  ...
                  <h3 className={`text-base sm:text-lg lg:text-xl font-bold ${isDarkMode ? 'text-white' : 'text-[#3D67FF]'} mb-2 sm:mb-3 px-2`}>Add Student</h3>
                ...
                <div className="text-center scroll-animate animation-delay-200">
                  ...
                  <h3 className={`text-base sm:text-lg lg:text-xl font-bold ${isDarkMode ? 'text-white' : 'text-[#3D67FF]'} mb-2 sm:mb-3 px-2`}>Generate Syllabus</h3>
                  <p className={`text-xs sm:text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} leading-relaxed px-2`}>
                ...
                <div className="text-center scroll-animate animation-delay-300">
                  ...
                  <h3 className={`text-base sm:text-lg lg:text-xl font-bold ${isDarkMode ? 'text-white' : 'text-[#3D67FF]'} mb-2 sm:mb-3 px-2`}>Plan Lessons</h3>
                  <p className={`text-xs sm:text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} leading-relaxed px-2`}>
                ...
                <div className="text-center scroll-animate animation-delay-400">
                  ...
                  <h3 className={`text-base sm:text-lg lg:text-xl font-bold ${isDarkMode ? 'text-white' : 'text-[#3D67FF]'} mb-2 sm:mb-3 px-2`}>Personalize</h3>
                  <p className={`text-xs sm:text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} leading-relaxed px-2`}>
          ...
          <section id="ai-tools" className={`py-12 sm:py-16 lg:py-20 ${isDarkMode ? 'bg-gradient-to-b from-gray-700 to-gray-800' : 'bg-gradient-to-b from-white to-gray-50'} transition-colors duration-300`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-8 sm:mb-12 lg:mb-16 scroll-animate">
                <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 animate-fade-in-up px-2">
                  <span className={isDarkMode ? 'text-white' : 'text-[#3D67FF]'}>Meet Your AI</span>
                  <br />
                  <span className={isDarkMode ? "bg-gradient-to-r from-blue-300 to-blue-300 bg-clip-text text-transparent" : "text-[#3D67FF]"}>
                    Teaching Assistants
                  </span>
                ...
                {aiTools.map((tool, index) => (
                  <div key={index} className={`${isDarkMode ? 'bg-gray-800/50 border-gray-700 hover:border-gray-600' : 'bg-white/70 border-gray-200 hover:border-gray-300'} backdrop-blur-sm rounded-xl overflow-hidden border transition-all duration-300 hover:transform hover:scale-105 hover:shadow-2xl hover:-translate-y-3 group scroll-animate ${index === 2 && 'sm:col-span-2 lg:col-span-1'}`} style={{animationDelay: `${index * 150}ms`}}>
                    ...
                    <div className="p-3 xs:p-4 sm:p-6 lg:p-8">
                      <h3 className={`text-base xs:text-lg sm:text-xl lg:text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-[#3D67FF]'} mb-2 sm:mb-3 lg:mb-4 group-hover:text-blue-400 transition-colors duration-300`}>
                        {tool.title}
                      </h3>
          ...
          <section id="why-choose-us" className={`py-12 sm:py-16 lg:py-20 ${isDarkMode ? 'bg-gradient-to-b from-gray-800 to-gray-700' : 'bg-gradient-to-b from-gray-50 to-white'} transition-colors duration-300`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-8 sm:mb-12 lg:mb-16 scroll-animate">
                <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 animate-fade-in-up px-2">
                  <span className={isDarkMode ? 'text-white' : 'text-[#3D67FF]'}>Why Homeschooling Educators</span>
                  <br />
                  <span className={isDarkMode ? "bg-gradient-to-r from-blue-300 to-blue-300 bg-clip-text text-transparent" : "text-[#3D67FF]"}>
                    Love Dumroo AI
                  </span>
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                <div className={`text-center ${isDarkMode ? 'bg-gray-800/50 border-gray-700 hover:border-gray-600' : 'bg-white/70 border-gray-200 hover:border-gray-300'} backdrop-blur-sm rounded-xl p-4 sm:p-6 lg:p-8 border transition-all duration-300 hover:transform hover:scale-105 hover:shadow-xl hover:-translate-y-2 group scroll-animate`}>
                  <div className="mb-4 sm:mb-6">
                    <div className={`text-2xl xs:text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold bg-clip-text text-transparent mb-1 sm:mb-2 group-hover:scale-110 transition-transform duration-300 ${isDarkMode ? 'bg-gradient-to-r from-blue-300 to-blue-300' : 'text-[#3D67FF]'}`}>
                      50%
                    </div>
                    <div className={`text-base sm:text-lg lg:text-xl font-semibold ${isDarkMode ? 'text-white' : 'text-[#3D67FF]'} mb-1 sm:mb-2 group-hover:text-blue-400 transition-colors duration-300`}>
                      Time Saved
                    </div>
                ...
                <div className={`text-center ${isDarkMode ? 'bg-gray-800/50 border-gray-700 hover:border-gray-600' : 'bg-white/70 border-gray-200 hover:border-gray-300'} backdrop-blur-sm rounded-xl p-4 sm:p-6 lg:p-8 border transition-all duration-300 hover:transform hover:scale-105 hover:shadow-xl hover:-translate-y-2 group scroll-animate animation-delay-100`}>
                  <div className="mb-4 sm:mb-6">
                    <div className={`text-2xl xs:text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold bg-clip-text text-transparent mb-1 sm:mb-2 group-hover:scale-110 transition-transform duration-300 ${isDarkMode ? 'bg-gradient-to-r from-blue-400 to-teal-400' : 'text-[#3D67FF]'}`}>
                      85%
                    </div>
                    <div className={`text-base sm:text-lg lg:text-xl font-semibold ${isDarkMode ? 'text-white' : 'text-[#3D67FF]'} mb-1 sm:mb-2 group-hover:text-blue-400 transition-colors duration-300`}>
                      Better Outcomes
                ...
                <div className={`text-center ${isDarkMode ? 'bg-gray-800/50 border-gray-700 hover:border-gray-600' : 'bg-white/70 border-gray-200 hover:border-gray-300'} backdrop-blur-sm rounded-xl p-4 sm:p-6 lg:p-8 border transition-all duration-300 hover:transform hover:scale-105 hover:shadow-xl hover:-translate-y-2 group scroll-animate animation-delay-200`}>
                  <div className="mb-4 sm:mb-6">
                    <div className={`text-2xl xs:text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold bg-clip-text text-transparent mb-1 sm:mb-2 group-hover:scale-110 transition-transform duration-300 ${isDarkMode ? 'bg-gradient-to-r from-teal-400 to-blue-400' : 'text-[#3D67FF]'}`}>
                      90%
                    </div>
                    <div className={`text-base sm:text-lg lg:text-xl font-semibold ${isDarkMode ? 'text-white' : 'text-[#3D67FF]'} mb-1 sm:mb-2 group-hover:text-teal-400 transition-colors duration-300`}>
                      Engagement
                    </div>
                    <p className={`text-xs sm:text-sm lg:text-base ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                ...
                <div className={`text-center ${isDarkMode ? 'bg-gray-800/50 border-gray-700 hover:border-gray-600' : 'bg-white/70 border-gray-200 hover:border-gray-300'} backdrop-blur-sm rounded-xl p-4 sm:p-6 lg:p-8 border transition-all duration-300 hover:transform hover:scale-105 hover:shadow-xl hover:-translate-y-2 group scroll-animate animation-delay-300`}>
                  <div className="mb-4 sm:mb-6">
                    <div className={`text-2xl xs:text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold bg-clip-text text-transparent mb-1 sm:mb-2 group-hover:scale-110 transition-transform duration-300 ${isDarkMode ? 'bg-gradient-to-r from-blue-400 to-blue-400' : 'text-[#3D67FF]'}`}>
                      100%
                    </div>
                    <div className={`text-base sm:text-lg lg:text-xl font-semibold ${isDarkMode ? 'text-white' : 'text-[#3D67FF]'} mb-1 sm:mb-2 group-hover:text-blue-400 transition-colors duration-300`}>
                      Personalization
          ...
          <section id="testimonials" className={`py-12 sm:py-16 lg:py-20 ${isDarkMode ? 'bg-gradient-to-b from-gray-700 to-gray-900' : 'bg-gradient-to-b from-white to-gray-50'} transition-colors duration-300`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-8 sm:mb-12 lg:mb-16 scroll-animate">
                <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 animate-fade-in-up px-2">
                  <span className={isDarkMode ? 'text-white' : 'text-[#3D67FF]'}>Trusted by</span>
                  <br />
                  <span className={isDarkMode ? "bg-gradient-to-r from-teal-300 to-blue-300 bg-clip-text text-transparent" : "text-[#3D67FF]"}>
                ...
                {testimonials.map((testimonial, index) => (
                  <div key={index} className={`${isDarkMode ? 'bg-gray-800/50 border-gray-700 hover:border-gray-600' : 'bg-white/70 border-gray-200 hover:border-gray-300'} backdrop-blur-sm rounded-xl p-4 sm:p-6 lg:p-8 border transition-all duration-300 hover:transform hover:scale-105 hover:shadow-xl hover:-translate-y-2 group scroll-animate ${index === 2 && 'sm:col-span-2 lg:col-span-1'}`} style={{animationDelay: `${index * 150}ms`}}>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 lg:gap-4">
                      ...
                      <div>
                        <div className={`text-xs xs:text-sm lg:text-base font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'} group-hover:text-blue-400 transition-colors duration-300`}>{testimonial.name}</div>
          ...
          {/* CTA Section */}
          <section className={`py-12 sm:py-16 lg:py-20 ${isDarkMode ? 'bg-gradient-to-r from-blue-900 via-gray-900 to-blue-900' : 'bg-gradient-to-r from-blue-100 via-gray-50 to-blue-100'} transition-colors duration-300`}>
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center scroll-animate">
              <h2 className={`text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 ${isDarkMode ? 'text-white' : 'text-[#3D67FF]'} animate-fade-in-up px-2`}>
      ...
      {currentPage === 'recent-activity' && <RecentActivity isDarkMode={isDarkMode} />}
      ...
      <footer className={`${isDarkMode ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-200'} border-t py-8 sm:py-10 lg:py-12 transition-colors duration-300`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-y-8 gap-x-4 sm:gap-x-6 lg:gap-x-8 mb-6 sm:mb-8">
            ...
            {/* Contact Us Section */}
            <div>
              <h3 className={`${isDarkMode ? 'text-white' : 'text-gray-900'} font-semibold mb-3 sm:mb-4 text-sm sm:text-base`}>Contact Us</h3>
              <ul className={`space-y-1.5 sm:space-y-2 text-xs sm:text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                ...
                <li>
                  <a href="mailto:info@dumroo.ai" className={`${isDarkMode ? 'hover:text-white' : 'hover:text-gray-900'} transition-all duration-300 hover:translate-x-1`}>
                    info@dumroo.ai
                  </a>
                </li>
                <li>
            ...
            {/* Quick Links Section */}
            <div>
              <h3 className={`${isDarkMode ? 'text-white' : 'text-gray-900'} font-semibold mb-3 sm:mb-4 text-sm sm:text-base`}>Quick Links</h3>
              <ul className="space-y-1.5 sm:space-y-2">
                <li><a href="#" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 text-xs sm:text-sm hover:translate-x-1`}>About Us</a></li>
                <li><a href="https://dumroo.ai/news" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 text-xs sm:text-sm hover:translate-x-1`}>News</a></li>
                <li><a href="https://dumroo.ai/blog" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 text-xs sm:text-sm hover:translate-x-1`}>Blog</a></li>
                <li><a href="https://dumroo.ai/gallery" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 text-xs sm:text-sm hover:translate-x-1`}>Gallery</a></li>
                <li><a href="https://dumroo.ai/contact" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 text-xs sm:text-sm hover:translate-x-1`}>Contact</a></li>
              </ul>
            </div>

            {/* Resources Section */}
            <div>
              <h3 className={`${isDarkMode ? 'text-white' : 'text-gray-900'} font-semibold mb-3 sm:mb-4 text-sm sm:text-base`}>Resources</h3>
              <ul className="space-y-1.5 sm:space-y-2">
                <li><a href="https://dumroo.ai/academy" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 text-xs sm:text-sm hover:translate-x-1`}>Dumroo Academy</a></li>
                <li><a href="https://pioneers.dumroo.ai/" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 text-xs sm:text-sm hover:translate-x-1`}>Pioneer Teachers</a></li>
                <li><a href="https://dumroo.ai/privacy" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 text-xs sm:text-sm hover:translate-x-1`}>Privacy Policy</a></li>
                <li><a href="https://qtiknlfjwgcshfrcqznk.supabase.co/storage/v1/object/sign/companyassets/Terms%20of%20Service%20v1.0.pdf?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJjb21wYW55YXNzZXRzL1Rlcm1zIG9mIFNlcnZpY2UgdjEuMC5wZGYiLCJpYXQiOjE3NDIyMDAxNTIsImV4cCI6MTgwNTI3MjE1Mn0.X1MgpS7g3Zj1Mpe513as_KMH5ak_pIWBNUQaEcE8aOo" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 text-xs sm:text-sm hover:translate-x-1`}>Terms of Service</a></li>
                <li><a href="https://help.dumroo.ai/" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 text-xs sm:text-sm hover:translate-x-1`}>Help Center</a></li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-1">
              {/* Connect With Us */}
              <h3 className={`${isDarkMode ? 'text-white' : 'text-gray-900'} font-semibold mb-3 sm:mb-4 text-sm sm:text-base`}>Connect With Us</h3>
              <div className="flex space-x-4 mb-6 sm:mb-8">
                <a href="https://www.facebook.com/people/Dumrooai-AI-Ecosystem-for-Education/61571653776425/" target="_blank" rel="noopener noreferrer" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 transform hover:scale-125`}>
                ...
                <a href="https://www.instagram.com/dumroo.ai/#" target="_blank" rel="noopener noreferrer" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 transform hover:scale-125`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                ...
                <a href="https://www.linkedin.com/company/dumroo-ai-ecosystem-for-education" target="_blank" rel="noopener noreferrer" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 transform hover:scale-125`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                    <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm-2.812 19.333H7.042V9.083h2.146v10.25zM8.042 8.167c-.708 0-1.292-.583-1.292-1.292s.584-1.292 1.292-1.292 1.292.583 1.292 1.292-.584 1.292-1.292 1.292zm11.291 11.166h-2.146v-5.208c0-1.25-.917-1.875-1.792-1.875-.875 0-1.667.625-1.667 1.875v5.208h-2.146V9.083h2.146v1.25h.083c.333-.625 1.042-1.25 2.083-1.25 1.458 0 2.5 1.042 2.5 3.125v7.125z"/>
                  </svg>
                </a>
                <a href="https://x.com/Damroo_AI" target="_blank" rel="noopener noreferrer" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 transform hover:scale-125`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
              ...
              <h3 className={`${isDarkMode ? 'text-white' : 'text-gray-900'} font-semibold mb-3 sm:mb-4 text-sm sm:text-base`}>Subscribe to Our Newsletter</h3>
              <div className="flex flex-col sm:flex-row gap-2">
                <input 
                  type="email" 
                  placeholder="Your email" 
                  className={`flex-1 p-2 rounded-md border ${isDarkMode ? 'bg-gray-700 border-gray-600 text-white placeholder-gray-400' : 'bg-white border-gray-300 text-gray-900 placeholder-gray-500'} focus:outline-none focus:ring-2 focus:ring-blue-400 transition-colors duration-300 text-sm`}
                />
                <button className="bg-gradient-to-r from-blue-400 to-blue-400 hover:from-blue-500 hover:to-blue-500 px-4 py-2 rounded-md font-medium text-white text-sm transition-all duration-300 transform hover:scale-105">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          {/* Bottom Section */}
          <div className={`pt-6 sm:pt-8 border-t ${isDarkMode ? 'border-gray-800' : 'border-gray-200'} flex flex-col sm:flex-row justify-between items-center gap-4`}>
            ...
            <div className="flex items-center space-x-3 sm:space-x-6 text-xs sm:text-sm">
              <a href="https://dumroo.ai/privacy" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 hover:scale-105 whitespace-nowrap`}>Privacy Policy</a>
              <a href="https://qtiknlfjwgcshfrcqznk.supabase.co/storage/v1/object/sign/companyassets/Terms%20of%20Service%20v1.0.pdf?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJjb21wYW55YXNzZXRzL1Rlcm1zIG9mIFNlcnZpY2UgdjEuMC5wZGYiLCJpYXQiOjE3NDIyMDAxNTIsImV4cCI6MTgwNTI3MjE1Mn0.X1MgpS7g3Zj1Mpe513as_KMH5ak_pIWBNUQaEcE8aOo" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 hover:scale-105 whitespace-nowrap`}>Terms of Service</a>
              <a href="https://dumroo.ai/sitemap" className={`${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-all duration-300 hover:scale-105 whitespace-nowrap`}>Sitemap</a>
            </div>
          </div>
        </div>
      </footer>
